...
def nullstellen(f,a,b,number_of_test_values): #a<b !   a=0.1 , b= 4,t=2
...
operators=["sin","cos","exp","log","cosh","sinh","tan","tanh","arccos","arcsin","arctan","arccosh","arcsinh","arctanh"]
...
def tree(f):
    ...
    if "+" in simplified:
        ...
        return [factorized[0],tree(factorized[1])]
    ...
    if is_sum_or_prod == True:
        ...
        for factor_index  in range(len(factorized[1])):
            ...
            while "{}" in factorized[1][factor_index]:
                ...
                factorized[1][factor_index] = factorized[1][factor_index].replace("{}","("+place_holders[holder_counter]+")", 1)
